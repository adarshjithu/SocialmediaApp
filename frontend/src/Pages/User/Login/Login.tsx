...
function Login() {
    ...
    return (
        <div className="w-full h-screen bg-[#E0E0E0] d flex justify-center items-center">
            <div className="bg-white h-[70%] md:h-[500px] sm:h-[500px]   w-[768px] rounded-[20px] flex m-4 shadow-[2px_2px_15px_grey]">
                    ...
                    <form action="" className="flex flex-col">
                        <div className="p-8 ">
                            ...
                            <div className="w-[100%] forget">
                                <span className="cursor-pointer" onClick={() => navigate("/verify-email")}>Forget Password</span>
                            </div>
                            <Button
